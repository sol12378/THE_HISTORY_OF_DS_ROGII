"""ROGII exp037 w07 — Hybrid (PF/multi-tw/physical-lik/geom blend) × leak lookup.

これまでの実験結果を踏まえた最強構成 + leak lookup の hybrid 0.3/0.7 (leak weight 0.7).
...
W_PF_PHYS = 0.15
W_GEOM = 0.05
# Hybrid weight: 0.3 model + 0.7 leak (testing transferability with risk hedge)
HYBRID_W_MODEL = 0.3
HYBRID_W_LEAK = 0.7
SMOOTH_W = 101

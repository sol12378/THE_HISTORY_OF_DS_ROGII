"""ROGII exp037 w03 — Hybrid (PF/multi-tw/physical-lik/geom blend) × leak lookup.

これまでの実験結果を踏まえた最強構成 + leak lookup の hybrid 0.7/0.3 (leak weight 0.3).
...
W_PF_PHYS = 0.15
W_GEOM = 0.05
# Hybrid weight: 0.7 model + 0.3 leak (testing transferability with risk hedge)
HYBRID_W_MODEL = 0.7
HYBRID_W_LEAK = 0.3
SMOOTH_W = 101

"""ROGII exp037 w10 — Hybrid (PF/multi-tw/physical-lik/geom blend) × leak lookup.

これまでの実験結果を踏まえた最強構成 + leak lookup の hybrid 0.0/1.0 (leak weight 1.0 - pure leak).
...
W_PF_PHYS = 0.15
W_GEOM = 0.05
# Hybrid weight: 0.0 model + 1.0 leak (testing transferability with risk hedge)
HYBRID_W_MODEL = 0.0
HYBRID_W_LEAK = 1.0
SMOOTH_W = 101
